...
{
    [ExportCodeFixProvider(LanguageNames.CSharp, Name = nameof(TryGetValueDiscardContainsKeyAnalyzerCodeFixProvider)), Shared]
    public class TryGetValueDiscardContainsKeyAnalyzerCodeFixProvider : CodeFixProvider
    {
        private readonly string title = Resources.MD0011AnalyzerTitle;

        public sealed override ImmutableArray<string> FixableDiagnosticIds
        {
            get { return ImmutableArray.Create(TryGetValueDiscardAnalyzer.TryGetValueDiscardContainsKeyDiagnosticId); }
        }
